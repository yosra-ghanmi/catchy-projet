                                ...
                                <div class="bg-white shadow rounded overflow-hidden">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-3 flex justify-between items-center">
                                            <a href="{{ route('events.show', $favorite->event->id) }}" class="bg-primary-600 text-white px-4 py-2 rounded hover:bg-primary-700">View Details</a>
                                            <form action="{{ route('events.favorite', $favorite->event->id) }}" method="POST" class="inline">
                                                @csrf
                                                @method('POST')
                                                <button type="submit" class="text-accent-600 hover:text-accent-800">
